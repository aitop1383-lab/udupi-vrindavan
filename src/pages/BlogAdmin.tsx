          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="relative">
              <input
                ...
                className={`w-full px-8 py-4 bg-brand-blue/[0.02] border border-brand-blue/10 focus:bg-white focus:border-brand-gold focus:ring-4 focus:ring-brand-gold/10 rounded-2xl outline-none text-brand-blue text-center font-bold tracking-widest text-lg transition-all placeholder:text-brand-blue/20 ${error ? '!bg-red-50/50 !border-red-400 shake !ring-4 !ring-red-400/20 text-red-500' : ''
                  }`}
                autoFocus
              />
              {error && (
